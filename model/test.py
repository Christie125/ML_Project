...
#Seeing what coedfficients and bias the model has learned
...
#Time to actuallyually evaluate the model now to see if its any good at actually predicting exam scores
